    ...
    <div className="min-h-screen bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <nav className="mb-6 sm:mb-8">
          <Link href="/questions/java-basic" className="text-orange-600 hover:text-orange-700 transition-colors flex items-center gap-2 min-h-[44px] px-3 py-2 rounded-lg hover:bg-orange-50">
        ...
        <article className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-orange-500 to-amber-500 px-6 sm:px-8 py-6 sm:py-8">
            ...
            <p className="text-orange-100 mt-2 text-sm sm:text-base">Java 基础 · 异常处理机制</p>
          </div>
            ...
            <div className="space-y-4 sm:space-y-6">
              {questions.map((item, index) => (
                <div key={index} className="border-b border-gray-100 pb-4 sm:pb-6 last:border-0 last:pb-0">
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-amber-50 p-4 sm:p-5 rounded-xl border border-orange-100">
