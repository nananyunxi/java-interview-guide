  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100">
      <div className="max-w-4xl mx-auto px-4 py-8">
        <nav className="mb-8">
          <Link href="/questions/others" className="text-blue-600 hover:text-blue-700 transition-colors flex items-center gap-2">
        ...
        <article className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-blue-500 to-indigo-500 px-8 py-6">
            ...
            <p className="text-blue-100 mt-2">版本控制 · 团队协作必备</p>
          </div>
          <div className="p-8">
