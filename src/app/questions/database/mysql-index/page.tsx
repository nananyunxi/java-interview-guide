    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
        <nav className="mb-6 sm:mb-8">
          <Link href="/questions/database" className="text-emerald-600 hover:text-emerald-700 transition-all duration-300 flex items-center gap-2 min-h-[44px] px-4 py-2 rounded-xl hover:bg-emerald-50 hover:shadow-md group">
        ...
        <article className="bg-white rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 border border-gray-100 overflow-hidden">
          <div className="bg-gradient-to-r from-emerald-500 to-teal-500 px-6 sm:px-8 lg:px-10 py-8 sm:py-10 lg:py-12">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">
              💾 MySQL 索引面试题
            </h1>
            <p className="text-emerald-100 mt-3 text-sm sm:text-base lg:text-lg">数据库核心 · 索引优化必备</p>
          </div>
            ...
            <div className="space-y-4 sm:space-y-6 lg:space-y-8">
              {questions.map((item, index) => (
                <div key={index} className="border-b border-gray-100 pb-4 sm:pb-6 lg:pb-8 last:border-0 last:pb-0">
                  ...
                  <div className="bg-gradient-to-br from-emerald-50 to-teal-50 p-4 sm:p-5 lg:p-6 rounded-xl border border-emerald-100 hover:shadow-md transition-all duration-300">
