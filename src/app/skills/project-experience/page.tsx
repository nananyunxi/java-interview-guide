    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/skills" className="text-blue-600 hover:text-blue-700 transition-colors inline-flex items-center gap-1 text-xs">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-12 mb-6 space-y-3 px-4">
          <Link href="/skills/self-introduction" className="block w-full px-6 py-3 bg-white rounded-xl shadow-md hover:shadow-lg transition-all text-blue-600 font-medium text-center text-base">
            上一节：自我介绍
          </Link>
          <Link href="/skills/technical-answers" className="block w-full px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all font-medium text-center text-base">
            下一节：技术回答
          </Link>
        </div>
      </main>
