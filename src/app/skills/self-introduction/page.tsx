    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-teal-50 to-cyan-50">
      ...
      <header className="bg-white/80 backdrop-blur-sm shadow-sm sticky top-0 z-10">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between">
            ...
            <Link href="/skills" className="text-green-600 hover:text-green-700 transition-colors inline-flex items-center gap-1 text-xs sm:text-sm font-medium">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="mt-12 mb-6 space-y-4 px-4">
          <Link href="/skills" className="block w-full px-6 py-3.5 bg-white rounded-xl shadow-md hover:shadow-lg transition-all text-green-600 font-medium text-center text-base">
            <span>返回</span>
          </Link>
          <Link href="/skills/project-experience" className="block w-full px-6 py-3.5 bg-gradient-to-r from-green-600 to-teal-600 text-white rounded-xl shadow-md hover:shadow-lg transition-all font-medium text-center text-base">
            <span>上一节</span>
          </Link>
        </div>
      </main>
